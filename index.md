...
address: "UCSB Library, Collaboratory rm 2324; 525 UCen Road, Santa Barbara, CA"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "January 31, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Greg Janée", "Ian Lessing", "Jon Jablonski", "Zach Sisco"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
collaborative_notes: https://pad.carpentries.org/2020-01-31-UCSB-SQL            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: "86728849323"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p> __Windows Users:__ follow <a class="btn btn-info" href="https://www.sqlitetutorial.net/download-install-sqlite/">these instructions to use SQLite from the command prompt.</a></p>
</li>
